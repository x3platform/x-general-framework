...
public interface AccountMapper {
   ...
   * 保存记录
   *
   * @param param Account 实例详细信息
   * @return Account 实例详细信息
   */
   ...
   * @return 一个 Account 实例的详细信息
   */
  Account findOneByLoginName(@Param("login_name") String loginName);
   ...
   * @return 一个实例的详细信息
   */
  Account findOneByCertifiedMobile(@Param("certified_mobile") String certifiedMobile);
   ...
   * @return 一个实例的详细信息
   */
  Account findOneByCertifiedEmail(@Param("certified_email") String certifiedEmail);
   ...
   * @return 一个实例的详细信息
   */
  List<Account> findAllByRoleId(@Param("role_id") String roleId);
   ...
   * @return 一个实例的详细信息
   */
  List<Account> findAllByGroupId(@Param("group_id") String groupId);
  
  /**
   * 所有没有成员信息的帐号信息
   *
   * @param length 条数, 0 表示全部
   * @return 所有实例的详细信息
   */
   ...
   * @return Account 实例
   */
  Account loginCheckByLoginName(@Param("login_name") String loginName, @Param("password") String password);
  
  /**
   * 登陆检测
   *
   * @param certifiedMobile 已验证的手机
   * @param password  密码
   * @return Account 实例
   */
  Account loginCheckByCertifiedMobile(@Param("certified_mobile") String certifiedMobile, @Param("password") String password);
   ...
   * @return Account 实例
   */
  Account loginCheckByCertifiedEmail(@Param("certified_email") String certifiedEmail, @Param("password") String password);
