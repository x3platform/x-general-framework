...
public class StandardRoleController {
   ...
   * 业务服务接口
   */
  private StandardRoleService service = MembershipManagement.getInstance().getStandardRoleService();
  ...
  public String save(@RequestBody String data) {
    StandardRole entity = JSON.parseObject(data, StandardRoleInfo.class);
  ...
  public String findOne(@RequestBody String data) {
    ...
    StandardRole entity = service.findOne(id);
