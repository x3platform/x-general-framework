...
public interface RoleService {
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findAllByOrganizationUnitId(String organizationUnitId);
  
  /**
   * 查询某个组织节点下的所有角色信息
   *
   * @param organizationUnitId 父节标识
   * @param depth          深入获取的层次，0 表示只获取本层次，-1 表示全部获取
   * @return 所有实例 {@link Role} 的详细信息
   */
  List<Role> findAllByOrganizationUnitId(String organizationUnitId, int depth);
   ...
   * @return 一个 {@link Role} 实例的详细信息
   */
  List<Role> findAllByOrganizationUnitIdAndJobId(String organizationUnitId, String jobId);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findAllBetweenPriority(String organizationUnitId, int minPriority, int maxPriority);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findForwardLeadersByOrganizationUnitId(String organizationUnitId);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findForwardLeadersByOrganizationUnitId(String organizationUnitId, int level);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findBackwardLeadersByOrganizationUnitId(String organizationUnitId);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findBackwardLeadersByOrganizationUnitId(String organizationUnitId, int level);
   ...
   * @return 所有 {@link Role} 实例的详细信息
   */
  List<Role> findStandardGeneralRolesByOrganizationUnitId(String organizationUnitId, String standardGeneralRoleId);
   ...
   * @return 布尔值
   */
  boolean isExistName(String name, String organizationUnitId);
   ...
   *
   * @param name           角色名称
   * @param organizationUnitId 所属组织单元标识
   */
  String combineFullPath(String name, String organizationUnitId);
   ...
   */
  String combineDistinguishedName(String globalName, String organizationUnitId);
   ...
   */
  // DataTable GenerateStandardRoleMappingReport(String organizationUnitId, String standardRoleType);
   ...
   */
  // DataTable GenerateStandardRoleMappingReport(String organizationUnitId, String standardRoleType, String standardRoleIds);
  
  /**
   * 快速创建标准角色
   *
   * @param standardRoleType 标准角色类型
   * @param organizationUnitId   公司或项目标识
   * @param standardRoleId   标准角色标识
   * @param roleName         角色名称
   */
  int quickCreateRole(String standardRoleType, String organizationUnitId, String standardRoleId, String roleName);
   ...
   * @return
   */
  boolean isNormalAdmin(String id, String standardOrganizationUnit, String roleName);
