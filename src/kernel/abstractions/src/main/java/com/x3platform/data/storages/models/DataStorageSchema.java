package com.x3platform.data.storages.models;
...
public class DataStorageSchema
{
   ...
   * @return 存储策略类名
   */
  public String getStorageStrategyClassName() {
    return storageStrategyClassName;
  }
   ...
   * @param value 值
   */
  public void setStorageStrategyClassName(String value) {
    storageStrategyClassName = value;
  }
