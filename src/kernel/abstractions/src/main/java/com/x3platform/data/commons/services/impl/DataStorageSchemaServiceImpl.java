...
import com.x3platform.data.commons.mappers.DataStorageSchemaMapper;
...
public class DataStorageSchemaServiceImpl implements DataStorageSchemaService {
   ...
   * 获取下拉列表信息
   *
   * @return 所有相关 {@link DataStorageSchema} 实例的详细信息
   */
  @Override
  public List<DataStorageSchema> getCombobox() {
    return provider.getCombobox();
  }
}
