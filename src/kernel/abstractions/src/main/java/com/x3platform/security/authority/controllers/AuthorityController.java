package com.x3platform.security.authority.controllers;
...
@Lazy
@RestController
@RequestMapping("/api/sys/security/authority")
public class AuthorityController {
  ...
  public String findOne(@RequestBody String data) {
    ...
    Authority entity = this.service.findOne(id);
  ...
  public String findAll(@RequestBody String data) {
    ...
    List<Authority> list = this.service.findAll(query);
