...
public class DynamicTreeNode {
  ...
  public final void setCategoryIndex(String value) {
  ...
  public final void setHasChildren(boolean value) {
    mHasChildren = value;
  }
  ...
  public final void setDisabled(int value) {
    mDisabled = value;
  }
  ...
  public String toString() {
    ...
    if (this.getHasChildren() && this.getDisabled() == 1) {
      ...
      if (this.getUrl().toLowerCase().indexOf("javascript:") == 0) {
