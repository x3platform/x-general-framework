...
/**
 */
public class ApplicationSettingGroupInfo extends EntityClass implements ICacheable {
  ...
  private ApplicationSettingGroupInfo mParent;

  /**
   * 应用
   */
  public final ApplicationSettingGroupInfo getParent() {
