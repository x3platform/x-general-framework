...
public class ApplicationOptionController {
  ...
  private ApplicationOptionService optionService ;
  /**
   * 查询所有系统共用节点
   */
  ...
  public String ApplicationOption(@RequestBody java.lang.String data){
    ...
    if(StringUtil.isNullOrEmpty(applicationKey)){
      ...
      List<ApplicationOption> dataList = optionService.getApplicationOption(applicationKey);
  ...
  public String isAdmin(@RequestBody java.lang.String data){
    ...
    if(StringUtil.isNullOrEmpty(applicationKey)){
      ...
      ApplicationOption optionInfo = optionService.getApplicationOption(applicationKey,"Apps.Administrators");
