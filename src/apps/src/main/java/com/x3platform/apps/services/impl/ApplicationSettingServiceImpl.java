...
public class ApplicationSettingServiceImpl implements ApplicationSettingService {
   ...
   * 参数文本信息缓存存储
   */
  private HashMap<String, ApplicationSetting> settingTextDictionary = new HashMap<String, ApplicationSetting>();

  /**
   * 参数值信息缓存存储
   */
  private HashMap<String, ApplicationSetting> settingValueDictionary = new HashMap<String, ApplicationSetting>();
  ...
  private void syncLocalDb() {
    ...
    if (settingTextDictionary.isEmpty()) {
      synchronized (lockObject) {
        if (settingTextDictionary.isEmpty()) {
          List<ApplicationSetting> list = this.findAll();
   ...
   * @return 返回所有实例 ApplicationSetting 的详细信息
   */
  // public List<ApplicationSetting> findAll(String whereClause) {
   ...
   * @return 返回所有实例 ApplicationSetting 的详细信息
   */
  // public List<ApplicationSetting> findAll(String whereClause, int length) {
   ...
   * @param whereClause SQL 查询条件
   * @param length      条数
   * @return 返回所有实例 ApplicationSettingLite 的详细信息
   */
  // public List<ApplicationSettingLite> findAllQueryObject(String whereClause, int length) {
   ...
   */
  @Override
  public List<ApplicationSetting> findAllByApplicationSettingGroupName(String applicationSettingGroupName, String keyword) {
    if (!StringUtil.isNullOrEmpty(keyword)) {
      keyword = "%" + keyword + "%";
    }
   ...
   */
  // public List<ApplicationSetting> GetPaging(int startIndex, int pageSize, DataQuery query, tangible.RefObject<Integer> rowCount) {
   ...
   */
  // public List<ApplicationSettingLite> GetQueryObjectPaging(int startIndex, int pageSize, String whereClause, String orderBy, tangible.RefObject<Integer> rowCount) {
  ...
  public String getText(String applicationId, String applicationSettingGroupName, String value) {
    ApplicationSetting param = FetchDictionaryItem(applicationId, applicationSettingGroupName, "value", value);
  ...
  public String getValue(String applicationId, String applicationSettingGroupName, String text) {
    ApplicationSetting param = FetchDictionaryItem(applicationId, applicationSettingGroupName, "value", text);
   ...
   * 获取需要同步的数据
   */
  private ApplicationSetting FetchDictionaryItem(String applicationId, String applicationSettingGroupName, String fetchItemType, String fetchItemValue) {
    ApplicationSetting param = null;
