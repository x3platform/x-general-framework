 ...
 * @author ruanyu
 */
public class TaskWaitingItemServiceImpl implements TaskWaitingItemService {
  /**
   * 数据提供器
   */
  @Autowired
  private TaskWaitingItemMapper provider = null;
   ...
   * @return 实例 TaskWaitingItem 详细信息
   */
  @Override
  public int save(TaskWaitingItem entity) {
    int affectedRows = -1;
   ...
   */
  @Override
  public TaskWaitingItem findOne(String id) {
   ...
   */
  @Override
  public List<TaskWaitingItem> findAll(DataQuery query)
  {
