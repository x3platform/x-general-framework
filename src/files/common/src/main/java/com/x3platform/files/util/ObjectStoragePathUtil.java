...
import com.x3platform.files.configuration.*;
 ...
 * 上传路径管理
 */
public final class ObjectStoragePathUtil {
  /**
   * 创建上传文件夹物理路径
   * @return 物理路径
   */
  public static String createPhysicalUploadFolder() {
    File physicalFolderPath = new File(ObjectStorageConfigurationView.getInstance().getPhysicalUploadFolder());
  ...
  public static String getPhysicalUploadFolder() {
    return DirectoryUtil.formatLocalPath(new File(ObjectStorageConfigurationView.getInstance().getPhysicalUploadFolder()).getAbsolutePath() + PathUtil.getFileSeparator());
  }
  ...
  public static String getVirtualUploadFolder() {
    return ObjectStorageConfigurationView.getInstance().getVirtualUploadFolder();
  }
  ...
  public static String getVirtualPathFormat(String attachmentFolder, ObjectStorageFile attachment) {
    return "{uploads}"
  ...
  public static String getFileFolder(String virtualPath, String folderRule) {
  ...
  public static String parseRule(String folder, java.time.LocalDateTime datetime) {
    ...
    String text = ObjectStorageConfigurationView.getInstance().getPhysicalUploadFolderRule();
