...
public class ConnectAccessToken {
  ...
  private LocalDateTime expireDate = java.time.LocalDateTime.MIN;
  ...
  public final long getExpiresIn() {
    ...
    return (DateUtil.toDate(this.getExpireDate()).getTime() - DateUtil.toDate(LocalDateTime.now()).getTime()) / 1000;
  }
  ...
  public final void setModifiedDate(LocalDateTime value) {
